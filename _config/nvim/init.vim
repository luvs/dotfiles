...
" Theme
source $HOME/.config/nvim/plugins-config/base16-vim.vim
source $HOME/.config/nvim/theme.vim

" Plugins
source $HOME/.config/nvim/plugins-config/vim-which-key.vim
source $HOME/.config/nvim/plugins-config/coc.vim
source $HOME/.config/nvim/plugins-config/coc-extensions.vim
source $HOME/.config/nvim/plugins-config/fzf.vim
source $HOME/.config/nvim/plugins-config/vim-gitgutter.vim
source $HOME/.config/nvim/plugins-config/git-messenger.vim
...
source $HOME/.config/nvim/plugins-config/vim-easymotion.vim
...
source $HOME/.config/nvim/plugins-config/vim-startify.vim
source $HOME/.config/nvim/plugins-config/vista.vim
source $HOME/.config/nvim/plugins-config/goyo.vim
source $HOME/.config/nvim/plugins-config/codi.vim
source $HOME/.config/nvim/plugins-config/far.vim
source $HOME/.config/nvim/plugins-config/tagalong.vim
source $HOME/.config/nvim/plugins-config/asynctasks.vim
