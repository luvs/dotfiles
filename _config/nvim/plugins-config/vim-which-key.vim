...
let g:which_key_map['0'] = [ ':BufferGoto 0'                                   , 'buffer 0' ]
let g:which_key_map['c'] = [ ':call Comment()'                                 , 'comment' ]
let g:which_key_map['e'] = [ ':CocCommand explorer --toggle --sources=file+'   , 'explorer' ]
let g:which_key_map['h'] = [ '<C-W>s'                                          , 'split below']
let g:which_key_map['j'] = [ '<Plug>(easymotion-j)'                            , 'jump to string down']
let g:which_key_map['k'] = [ '<Plug>(easymotion-k)'                            , 'jump to string up']
let g:which_key_map['n'] = [ ':let @/ = ""'                                    , 'no highlight' ]
let g:which_key_map['p'] = [ ':RnvimrToggle'                                   , 'open' ]
...
let g:which_key_map.w = {
      \ 'name' : '+windows' ,
      \ 'm' : [':MaximizerToggle'                        , 'maximize window'],
      \ 's' : [':call WindowSwap#EasyWindowSwap()'       , 'move window'],
      \ }
