...
if [[ $HAS_SUDO == 0 ]]; then
  ...
  sudo scutil --set ComputerName "el"
  sudo scutil --set HostName "el"
  sudo scutil --set LocalHostName "el"
  sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "el"
